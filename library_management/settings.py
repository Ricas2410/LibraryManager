...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-mu=ek1hw!jy!sngo2j!*g_g_9%79sj$o#k!!od2juw2nk=kk48')
...
SCHOOL_API_URL = config('SCHOOL_API_URL', default='')
SCHOOL_API_KEY = config('SCHOOL_API_KEY', default='')
